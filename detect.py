...
def parse_opt():
    ...
    parser.add_argument('--save-geojson', action='store_true', help='save prediction boxes as geojson')
    parser.add_argument('--save-kml', action='store_true', help='save prediction boxes as kml')
